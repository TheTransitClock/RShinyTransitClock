...
where arrivalDepartureTime BETWEEN '2019-10-28' AND '2019-11-01'
...
ggsave(filename = "Cum_Ten_Min_By_Route_Oct_28_31.png", path = '/Users/simonberrebi2/Dropbox/KF_Paper/Figures/Cumulative_Error',
...
ggsave(filename = "Ten_Min_By_Route_Oct_28_31_Express2.png", path = '/Users/simonberrebi2/Dropbox/KF_Paper/Figures/Distribution_By_Route',
ggplot(subset(Ten_Min_By_Route, sample_size > 50 & as.numeric(routeshortname) >  650),                ### The data frame to use.
       aes(x     = routeshortname,
           y     = mean_error,
           color = predictionsource)) +
  geom_point(shape = 15,
