...
and arrivalDepartureTime BETWEEN '2019-10-28' AND '2019-11-01' 
...
ggsave(filename = "Interval_Oct28_31.png", path = '/Users/simonberrebi2/Dropbox/KF_Paper/Figures/Intervals',
ggplot() +
